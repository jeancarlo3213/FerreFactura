...
ECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'clave-segura-por-defecto')
...
ALLOWED_HOSTS = ['ferrefactura-production.up.railway.app', 'localhost']  # Si quieres restringir, agrega el dominio de Railway cuando lo tengas
